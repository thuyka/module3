...
<section id="home-section" class="hero">
	...
	@include('frontend.content.categories')

	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center mb-3 pb-3">
				<!-- [đặt làm tiêu đề thể loại] -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="{{route('home.productdetail', $product->id)}}" class="img-prod"><img src="{{ asset('public/upload/'.$product->image) }}" style="width: 200px; padding-left: 45px; padding-top: 30px" alt="Colorlib Template">
							<!-- <span class="status">30%</span> hiện % giảm giá -->
							<div class="overlay"></div>
						</a>
